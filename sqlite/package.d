...
enum SQLITE_IOERR_DATA = SQLITE_IOERR | (32 << 8);
enum SQLITE_IOERR_CORRUPTFS = SQLITE_IOERR | (33 << 8);
enum SQLITE_IOERR_IN_PAGE = SQLITE_IOERR | (34 << 8);
...
enum SQLITE_BUSY_TIMEOUT = SQLITE_BUSY | (3 << 8);
...
enum SQLITE_CANTOPEN_DIRTYWAL = SQLITE_CANTOPEN | (5 << 8);
enum SQLITE_CANTOPEN_SYMLINK = SQLITE_CANTOPEN | (6 << 8);
enum SQLITE_CORRUPT_VTAB = SQLITE_CORRUPT | (1 << 8);
enum SQLITE_CORRUPT_SEQUENCE = SQLITE_CORRUPT | (2 << 8);
enum SQLITE_CORRUPT_INDEX = SQLITE_CORRUPT | (3 << 8);
...
enum SQLITE_CONSTRAINT_PINNED = SQLITE_CONSTRAINT | (11 << 8);
enum SQLITE_CONSTRAINT_DATATYPE = SQLITE_CONSTRAINT | (12 << 8);
enum SQLITE_NOTICE_RECOVER_WAL = SQLITE_NOTICE | (1 << 8);
enum SQLITE_NOTICE_RECOVER_ROLLBACK = SQLITE_NOTICE | (2 << 8);
enum SQLITE_NOTICE_RBU = SQLITE_NOTICE | (3 << 8);
...
enum SQLITE_OK_SYMLINK = SQLITE_OK | (2 << 8);
...
enum SQLITE_OPEN_SUPER_JOURNAL = 0x00004000;
...
enum SQLITE_OPEN_NOFOLLOW = 0x01000000;
enum SQLITE_OPEN_EXRESCODE = 0x02000000;
...
enum SQLITE_FCNTL_SIZE_LIMIT = 36;
enum SQLITE_FCNTL_CKPT_DONE = 37;
enum SQLITE_FCNTL_RESERVE_BYTES = 38;
enum SQLITE_FCNTL_CKPT_START = 39;
enum SQLITE_FCNTL_EXTERNAL_READER = 40;
enum SQLITE_FCNTL_CKSM_FILE = 41;
enum SQLITE_FCNTL_RESET_CACHE = 42;
...
enum SQLITE_CONFIG_SMALL_MALLOC = 27;
enum SQLITE_CONFIG_SORTERREF_SIZE = 28;
enum SQLITE_CONFIG_MEMDB_MAXSIZE = 29;
enum SQLITE_CONFIG_ROWID_IN_VIEW = 30;
...
enum SQLITE_DBCONFIG_ENABLE_QPSG = 1007;
enum SQLITE_DBCONFIG_TRIGGER_EQP = 1008;
enum SQLITE_DBCONFIG_RESET_DATABASE = 1009;
enum SQLITE_DBCONFIG_DEFENSIVE = 1010;
enum SQLITE_DBCONFIG_WRITABLE_SCHEMA = 1011;
enum SQLITE_DBCONFIG_LEGACY_ALTER_TABLE = 1012;
enum SQLITE_DBCONFIG_DQS_DML = 1013;
enum SQLITE_DBCONFIG_DQS_DDL = 1014;
enum SQLITE_DBCONFIG_ENABLE_VIEW = 1015;
enum SQLITE_DBCONFIG_LEGACY_FILE_FORMAT = 1016;
enum SQLITE_DBCONFIG_TRUSTED_SCHEMA = 1017;
enum SQLITE_DBCONFIG_STMT_SCANSTATUS = 1018;
enum SQLITE_DBCONFIG_REVERSE_SCANORDER = 1019;
enum SQLITE_DBCONFIG_MAX = 1019;
...
enum SQLITE_PREPARE_NO_VTAB = 0x04;
...
enum SQLITE_TXN_NONE = 0;
enum SQLITE_TXN_READ = 1;
enum SQLITE_TXN_WRITE = 2;
...
enum SQLITE_INDEX_CONSTRAINT_LIMIT = 73;
enum SQLITE_INDEX_CONSTRAINT_OFFSET = 74;
...
enum SQLITE_MUTEX_STATIC_MAIN = 2;
...
enum SQLITE_TESTCTRL_FK_NO_ACTION = 7;
...
enum SQLITE_TESTCTRL_JSON_SELFCHECK = 14;
...
enum SQLITE_TESTCTRL_RESULT_INTREAL = 27;
enum SQLITE_TESTCTRL_PRNG_SEED = 28;
enum SQLITE_TESTCTRL_EXTRA_SCHEMA_CHECKS = 29;
enum SQLITE_TESTCTRL_SEEK_COUNT = 30;
enum SQLITE_TESTCTRL_TRACEFLAGS = 31;
enum SQLITE_TESTCTRL_TUNE = 32;
enum SQLITE_TESTCTRL_LOGEST = 33;
enum SQLITE_TESTCTRL_USELONGDOUBLE = 34;
enum SQLITE_TESTCTRL_LAST = 34;
...
enum SQLITE_STMTSTATUS_FILTER_MISS = 7;
enum SQLITE_STMTSTATUS_FILTER_HIT = 8;
...
enum SQLITE_SCANSTAT_PARENTID = 6;
enum SQLITE_SCANSTAT_NCYCLE = 7;
...
enum SQLITE_SERIALIZE_NOCOPY = 0x001;
...
enum SQLITE_DESERIALIZE_FREEONCLOSE = 1;
enum SQLITE_DESERIALIZE_RESIZEABLE = 2;
enum SQLITE_DESERIALIZE_READONLY = 4;
...
struct Fts5ExtensionApi
{
    ...
    int function (
        ...
        int iToken,
        const(char*)* ppToken,
        int* pnToken) xQueryToken;
    int function (Fts5Context*, int iIdx, int iToken, const(char*)*, int*) xInstToken;
}
